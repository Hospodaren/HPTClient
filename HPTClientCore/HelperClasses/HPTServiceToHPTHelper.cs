...
namespace HPTClient
{
    public class HPTServiceToHPTHelper
    {
        ...
        //        ConvertCalendar(calendar, hptCalendar);
        ...
        //                ConvertCalendarRaceDayInfo(rdi, hptRdi);
        ...
        public static void SetNonSerializedValues(HPTCombBet hcb)
        {
            ...
            //SetDistanceToHomeTrack(hcb.RaceDayInfo);  // TODO: Skippa det här?
        }
        ...
        public static void SetNonSerializedValues(HPTMarkBet hmb)
        {
            ...
            //SetTrainerAndDriver(hmb); // TODO: Uppdatera metod
            ...
            //// Sätt avstån till hemmabanan för alla hästar
            //SetDistanceToHomeTrack(hmb.RaceDayInfo);  // TODO: Fixa till metoden
